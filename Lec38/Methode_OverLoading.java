...
public class Methode_OverLoading {
	...
	public static int add(int a, int b) { //ye apne according argument me 2,4 lelega because argument me sirf 2 hi variable bheje h
		return a+b;	
	}
	
	public static int add(int a, int b, int c) {//ye apne according argument me 2,4,9 lelega  //ye apne according argument me 2,4 lelega because argument me sirf 3 hi variable bheje h
		return a+b+c;	
	}
	
	public static int add(int a, int b , double c) { //ye apne according argument me 2,4,9.7 lelega //argument me floating number b h isliye double c likha h 
		return (int) (a+b+c);                        // int isliye liya h bcoz argument me floating number b h eg:- 9.7
	}
...
//function OverLoading ke rules:-
//1- same class me hoga       //eg- isi class me use hoga
