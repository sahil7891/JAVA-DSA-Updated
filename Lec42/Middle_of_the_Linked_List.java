...
public class Middle_of_the_Linked_List {  //Leet code ques -> 876       
	...
	class Solution {
		public ListNode middleNode(ListNode head) { //head me 1st node ka address given hai  //jese hme LinkedList class me  - class ka name node diya tha wese hi yha class ka name ListNode diya hai                 
