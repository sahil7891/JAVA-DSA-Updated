...
//			if (age<0) {    // if age ki value -ve me hogi then print nhi hoga and niche syso wali line chlegi
//			System.out.println("sunbe pgl 'Age' kbhi -ve nhi hoti h");  //we have to write this massage as development point of view for eg - jese ptm and g pay ki transaction fail hone pr wo btata hai ki TRANSACTION IS FAILED
...
//	
//	public void setAge(int age) throws  Exception{ //throws  Exception - it tells exception might be generated and we have to write throws  Exception- bcoz we wrote throw new Exception below , if we don't write it there will be error
//
...
//			throw new Exception("pgl Age -ve nhi hoti");  //this line generates Exeption // throw  ka work ye h ki kisi method se explicitly btae ki hm Exeption generate kr rha hai			
//		}
//		this.age = age;
...
//	// 2nd way of exception handling
	...
	public void setAge(int age) {
		try {            // try ke andar wala code is called "danger code"  //if try me koi exception ata hai mean age ki value -ve ati h then code terminate nhi hoga baliki usse 'catch' me rakhdenge jisse code terminate nhi hoga and o/p me age me constructor wali line me jo age ki value h wahi age print hogi which is 24
			if (age<0) {
				throw new Exception("pgl Age -ve nhi hoti");  
			...
			e.printStackTrace();  //ye konsi line pr error hai wo b btata hai// eg-> o/p me ye line => at Lec36.Student.setAge(Student.java:50) <- means line no 50 pr error h
			                                          //e.printStackTrace(); --> its output =>//java.lang.Exception: pgl Age -ve nho hota
			                                                                                  //at Lec36.Student.setAge(Student.java:50)
                                                                                              //at Lec36.Student_Client.main(Student_Client.java:11)
		}
		finally {   // this is called finally block  // this code is mandatory and 'Age' ki value -ve ho ya +ve dono hi case me isse niche syso wala content print hoga
