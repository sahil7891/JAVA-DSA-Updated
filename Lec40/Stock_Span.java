...
public class Stock_Span {
	...
	public static void SPan_Cal(int []arr) { //void ka meaning ki integer return kr rhe hai 
		                                     //upr static function ke under call krna hai isliye iss function ka bhi static hona jruri h eg:- static --- static ke under hi call ho skta h         
		...
		for (int i = 0; i < span.length; i++) {  //loop for see below
			System.out.println(arr[i]+ " "+span[i]); //Print arr and span
