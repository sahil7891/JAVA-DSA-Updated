...
public class Facto1 {
	...
	public static int fact(int n, int ans) { // n me 5 aega // and ans me 1 (see in syso line) // base case me argument pass krte h tail recursion bnane ke liye eg:-ans me 1 diya hai         
		//base case
