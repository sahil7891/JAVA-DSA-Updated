...
public class First_Occ {
	...
	public static int FistIndex(int []arr,int i, int item) { //arr wali line array ka addres bhejegi // i=0(index no.) // item=3 see in syso line
		 if(i==arr.length) { //if i ki value array ki lenght se zada hogyi then 
			 return -1;      // "return -1" and -1 print hoga (return -1 main me jayega)  
		 }
