...
public class Subsequence {
	...
	public static void main(String[] args) {
		...
		String str ="abc";
		printSubSeq(str,""); //  " " is for khali(empty) string ke liye
	...
	public static void printSubSeq(String str, String ans) { //str and ans dono argument hai  // ans me empty string pass hoga
		...
		printSubSeq(str.substring(1),ans);   //str.substring(1) means string ke index no. 1 se character lega
		printSubSeq(str.substring(1),ans+ch); //str.substring(1) means string ke index no. 1 se character lega ,, ans me khali string and  ch me = a(0th index)
