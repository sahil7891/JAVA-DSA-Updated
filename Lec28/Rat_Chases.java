...
public class Rat_Chases {
	...
	static boolean f = false; //global variable bna diya
	...
	public static void path(char[][] maze, int cr, int cc,int[][] ans) {
		...
		int r[] = {0,0,-1,1};  //see in notebook
		int c[] = {1,-1,0,0};  //see in notebook
		...
		for (int i =0; i <c.length; i++) {      // 4 direction me move krna h then 4 br recursive cl legi
			...
			// 4ro Direction ke liye code niche likha h jo ki 4ro line commentout ki hui h // iss code ke bdle  upr for loop lga diya 4ro direction ke liye
