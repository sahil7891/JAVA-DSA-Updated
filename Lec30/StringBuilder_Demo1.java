...
public class StringBuilder_Demo1 {
	...
	public static void main(String[] args) {
	    ...
	    StringBuilder sb= new StringBuilder();//string builder is a builtin class in java //StringBuilder String se jada fast hota hai
	    sb.append("Hellow"); //StringBuilder me append ka means add hota hai // Hellow 'Builder' me ake store ho jayega
	    System.out.println(sb);
	    
	    sb.append("Hellow");  //append function piche piche add krta hai// Hellow ke piche hellow add krdiga
	    System.out.println(sb);  
