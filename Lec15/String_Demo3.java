...
public class String_Demo3 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.charAt(3));  // .charAt - is for getting the character from string index, eg=3(3rd index) which is "d" then printed
		...
		String s1 = str.substring(3,7); // new string created form index 3 to 7

		System.out.println(s1); // upr s1 ke contents prints honge which is from index 3 to 7
