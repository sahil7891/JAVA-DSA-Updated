...
// upr wala code from leet code
		public TreeNode deleteNode(TreeNode root, int key) {
			...
			//** now niche key(element) milte hi delete marenge** // now upr agar "if" "else" dono false hue means present node "key" wala node h jise delete krna h ab usse bst se delete marne ka code niche
			else {
				//Case 1:- agar jis node ko delete krna h uka sirf 1 child h see below code  // CASE 2:- it will have similar code see in notebook
...
//***CASE 3 ka Method 2 ***** , Method 2 ki help se we also get to know that how to get the node that have " Minimum DATA " in ******BST***** important for interview purpose
