...
public class Quick_Sort {
	...
	public static void QueckSort(int [] arr, int low, int high) {
		...
		int idx = Partition(arr,low ,high);  // demo wale code ka o/p 3 , 1 , 4 , 5 , 9 , 7 in which 4 is idx and the index no. of 4 is 2 then niche wale code ka stack frame bhi isi ke according bnega  
		                                     //and final o/p =1 , 3 , 4 , 5 , 7 , 9
		
		QueckSort(arr,low,idx-1); //idx(4) ke left wale ko sort krne ke liye
		QueckSort(arr,idx+1,high);//idx(4) ke right wale ko sort krne ke liye

		
	}
	public static int Partition(int [] arr, int low, int high) { // Quick_Sort_Demo - wali class me index wala method same to same h
