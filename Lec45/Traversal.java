...
//-------------------------------------------------                                 -------------------------------------
	...
	private void PostOrder(Node node) {  // node me root ka address aega // Post Order traversal // traversal => it means the process of visiting each node in the tree and processing its data
		...
		System.out.print(node.data+" "); //syso wali line last me likhi h isliye sari call lgne ke bd print hoga means stack se waps ate time 
		                                 //jb parent node ke left and right dono print ho jaenge then parent node print hoga //stack bnake solve krne pr jese notebook me o/p aya h wese hi aega
	}
	//-----------------------------------
	...
	public void LevelOrder() { //isme binary tree bni bnai mila h upr create tree method se and hm usse level order me print kr rhe h
