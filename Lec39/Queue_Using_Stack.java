...
public class Queue_Using_Stack {
	...
	public int Dequeue() throws Exception {     // see steps in notebook
       ...
       return x; //means x nikl gya , see in step 3
	}	
	public int getFront() throws Exception {  // Queue me spbse 1st index pr konsa data hoga iske liye but ise stack ki help se bnaya h isliye same Dequeue wale ki trh hoga bs yha (x = this.data.peek) pop ke bdle peek aega  
