...
public class Stack_Reverse {
	...
	public static void Reverse(Stack<Integer> st) { //st me 2k location capture hoga
		...
		if(st.isEmpty()) {//check krega ki given stack empty hui ki nhi //isEmpty isliye liya h bcos Stack Dynamic hai //base case
			return;
		}
		int x = st.pop(); //peek wale ko nikalega and x me peek wala element aega
		Reverse(st);      //recursive call 1
		Insert_Down(st,x);//Insert_Down function call hoga niche and argument me x pop kiya hua data h
	} 
