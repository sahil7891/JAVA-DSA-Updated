...
public class Prime_sieve {
	...
	public static void Primesieve(int n) {
		...
		boolean [] prime = new boolean[n+1];  //boolean ka array isme by default false value fill hoti hai // we assume if index me false hai then it's prime //[n+1] this is for 1 extra index because iss array me 0 se indexing hoti h and n-1 tk index ate hai   
		prime[0] = true; // because 0 prime nhi hota
		prime[1] = true; // because 1 bhi prime nhi hota
